...
<script>
    ...
    $.ajax({
        type: "get",
        url: "${pageContext.request.contextPath}/sys/qiantai/geren/recommend/countData?text_label="+"计算机系统",
        async: true,
        dataType: "json",
        ...
        layui.use('laytpl', function () {
            ...
            laypage.render({
                ...
                , jump: function (obj) {
                    ...
                    $.ajax({
                        type: "get",
                        url: "${pageContext.request.contextPath}/sys/qiantai/geren/recommend/listData?text_label="+"计算机系统"+"&curr="+curr+"&limit="+limit,
                        async: true,
                        dataType: "json",
                        contentType: "application/json;charset=UTF-8",
                        success: function (res) {
